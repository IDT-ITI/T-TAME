...
for version in versions:
    if version == "tame":
        ...
        model = TAMELIT.load_from_checkpoint(
            "/ssd/ntrougkas/Documents/T-TAME/logs/TAME_resnet50/version_5/checkpoints/"
            "epoch=3-step=160148.ckpt",
            LeRF=True,
        ...
        model = TAMELIT.load_from_checkpoint(
            "/ssd/ntrougkas/Documents/T-TAME/logs/lcam_resnet50_oldnorm/version_0"
